...
'    [["itemF136d3",136],"DashedSentence", {s: "It was the princess|who|was the eldest|that|wore|the prettiest necklace|at the king''s ball."},"Question",{q: "Did the youngest princess wear the prettiest necklace?"},"Form",{ html: { include: "recall.html" }},],'	
    [["item3b1",3],"FlashSentence",{s: "term ----- knife ----- bread"},"DashedSentence", {s: "It was the gun|that the actor|who|posed|for a photo|fired|during the robbery scene.|"},"Question",{q: "Was it an actor who posed for a photo?"},"Form",{ html: { include: "recall.html" }},],	
'    [["itemF89d3",89],"DashedSentence", {s: "The magician|explained|that|the children|liked|the trick|at the county fair."},"Question",{q: "Were the children vexed by the magician''s trick?"},"Form",{ html: { include: "recall.html" }},],'	
    ...
    [["item2a3",2],"FlashSentence",{s: "mess ----- guess ----- bless"},"DashedSentence", {s: "It was the dress|that the mother|who|worked|at the diner|wore|to the cocktail party.|"},"Question",{q: "Did the mother go to a restaurant?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item5a1",5],"FlashSentence",{s: "neck ----- deck ----- wreck"},"DashedSentence", {s: "It was the check|that the manager|who|presented|the sales figures|cashed|at the credit union.|"},"Question",{q: "Did the manager visit a credit union?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item7c1",7],"DashedSentence", {s: "It was the speech|that the candidate|who|registered|the new vehicle|delivered|to a crowded auditorium."},"Question",{q: "Was it a vehicle that the candidate registered?"},"Form",{ html: { include: "recall.html" }},],	
	
    [["item1c1",1],"DashedSentence", {s: "It was the boat|that the guy|who|drank|some hot coffee|sailed|on two sunny days.|"},"Question",{q: "Did the guy drink hot coffee?"},"Form",{ html: { include: "recall.html" }},],	
    [["item4c3",4],"DashedSentence", {s: "It was the gum|that the camper|who|forgot|to bring sunscreen|chewed|during the morning hike.|"},"Question",{q: "Did the camper forget to bring sandwiches?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item10c3",10],"DashedSentence", {s: "It was the phone|that the salesman|who|earned|a big commission|dialed|after the last appointment.|"},"Question",{q: "Was the salesman given a warning?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item8a3",8],"FlashSentence",{s: "bear ----- swear ----- chair"},"DashedSentence", {s: "It was the hair|that the cheerleader|who|listened|to the radio|shampooed|before the homecoming dance.|"},"Question",{q: "Was the cheerleader getting ready for the prom?"},"Form",{ html: { include: "recall.html" }},],	
	
	
    [["item11a1",11],"FlashSentence",{s: "drug ----- bug ----- hug"},"DashedSentence", {s: "It was the rug|that the employee|who|slept|through the meeting|swept|on a rainy afternoon.|"},"Question",{q: "Did the employee sleep through a meeting?"},"Form",{ html: { include: "recall.html" }},],	
	
	
    [["item14a3",14],"FlashSentence",{s: "sigh ----- lie ----- guy"},"DashedSentence", {s: "It was the pie|that the father|who|bought|a new condo|baked|for the cooking contest.|"},"Question",{q: "Was the pie baked for a Christmas party?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item13c1",13],"DashedSentence", {s: "It was the suit|that the accountant|who|purchased|a new computer|ironed|before the formal dinner.|"},"Question",{q: "Did the accountant buy a new computer?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item17a1",17],"FlashSentence",{s: " source ----- force ----- course"},"DashedSentence", {s: "It was the horse|that the visitor|who|paid|the parking ticket|rode|over a grassy hill."},"Question",{q: "Did the visitor ride over a hill?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item6b3",6],"FlashSentence",{s: "plate ----- lock ----- juice"},"DashedSentence", {s: "It was the song|that the student|who|attended|a private school|sang|during the evening performance.|"},"Question",{q: "Was it a teacher who sang a song?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item20a3",20],"FlashSentence",{s: "pain ----- cane ----- brain"},"DashedSentence", {s: "It was the plane|that the brother|who|moved|to the suburbs|piloted|until the unfortunate crash.|"},"Question",{q: "Did the brother always land the plane safely?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item16c3",16],"DashedSentence", {s: "It was the book|that the lady|who|attended|church last Sunday|read|at the local library.|"},"Question",{q: "Did the lady attend a town hall meeting last Sunday?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item23a1",23],"FlashSentence",{s:"plug ----- thug ----- slug"},"DashedSentence", {s: "It was the drug|that the physician|who|graduated|with high honors|injected|into the anxious patient.|"},"Question",{q: "Was the patient calm and relaxed?"},"Form",{ html: { include: "recall.html" }},],	
    [["item19c1",19],"DashedSentence", {s: "It was the beer|that the woman|who|won|the state lottery|drank|before the rock concert.|"},"Question",{q: "Was it the lottery that the woman won?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item9b1",9],"FlashSentence",{s: "comb ----- bag ----- text"},"FlashSentence",{s: "bar ----- jar ----- star"},"DashedSentence", {s: "It was the car|that the husband|who|applied|for a loan|drove|to the important interview.|"},"Question",{q: "Did the husband drive a car?"},"Form",{ html: { include: "recall.html" }},],	
	
    [["item12b3",12],"FlashSentence",{s: "salad ----- purse ----- frame"},"DashedSentence", {s: "It was the food|that the boy|who|collected|rare baseball cards|cooked|for the Thanksgiving holiday.|"},"Question",{q: "Did the sister cook the food?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item15b1",15],"FlashSentence",{s: "tea ----- music ----- court"},"DashedSentence", {s: "It was the lease|that the student|who|attended|the state college|signed|before the Fall semester."},"Question",{q: "Was it a student who signed the lease?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item18b3",18],"FlashSentence",{s: "doll ----- tire ----- silver"},"DashedSentence", {s: "It was the flower|that the wife|who|purchased|the new necklace|planted|after the heavy rainfall.|"},"Question",{q: "Was it a shrub that the wife planted?"},"Form",{ html: { include: "recall.html" }},],	
	
	
    [["item21b1",21],"FlashSentence",{s: "sky ----- safe ----- clerk"},"DashedSentence", {s: "It was the code|that the scientist|who|received|very generous funding|cracked|at the computer lab.|"},"Question",{q: "Did a scientist crack the code?"},"Form",{ html: { include: "recall.html" }},],	
	
	
	
    [["item24b3",24],"FlashSentence",{s: "town ----- charge ----- ghost"},"DashedSentence", {s: "It was the kite|that the girl|who|turned|twelve years old|flew|at the sandy beach.|"},"Question",{q: "Did the girl fly a remote-controlled airplane?"},"Form",{ html: { include: "recall.html" }},],	
	
    [["item22c3",22],"DashedSentence", {s: "It was the blender|that the adolescent|who|lived|by the ocean|unplugged|after the boring chores.|"},"Question",{q: "Did the adolescent live by the mountains?"},"Form",{ html: { include: "recall.html" }},],	
	
    [["item25c1",25],"DashedSentence", {s: "It was the snow|that the teenager|who|finished|the homework assignment|shoveled|after the sudden blizzard.|"},"Question",{q: "Did the teenager finish the homework?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item28c3",28],"DashedSentence", {s: "It was the money|that the clerk|who|filed|the monthly reports|deposited|at the local bank.|"},"Question",{q: "Did the clerk send the monthy reports to the main office?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item26a3",26],"FlashSentence",{s: "steak ----- lake ----- ache"},"DashedSentence", {s: "It was the cake|that the secretary|who|commuted|by city bus|baked|before the office party.|"},"Question",{q: "Was the cake baked for a birthday party?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item27b1",27],"FlashSentence",{s: "flag ----- bike ----- bottle"},"DashedSentence", {s: "It was the bride|that the man|who|arrived|later than scheduled|married|before the expensive reception.|"},"Question",{q: "Did the man marry the bride?"},"Form",{ html: { include: "recall.html" }},],	
    ...
    [["item29a1",29],"FlashSentence",{s: "tease ----- breeeze ----- freeze"},"DashedSentence", {s: "It was the cheese|that the waiter|who|hummed|a cheerful melody|grated|for the polite customers."},"Question",{q: "Was it cheese that the waiter brought to the customers?"},"Form",{ html: { include: "recall.html" }},],	
'    [["itemF143d3",143],"DashedSentence", {s: "It was the debutante|who|was nervous|that|opened|the expensive champagne|at her New Year''s gathering."},"Question",{q: "Was the debutante confident?"},"Form",{ html: { include: "recall.html" }},],'	
    ...
    [["item30b3",30],"FlashSentence",{s: "snack ----- ear ----- orange"},"DashedSentence", {s: "It was the lotion|that the baby|who|crawled|into the bathroom|squirted|across the tiled floor."},"Question",{q: "Did the baby squirt lotion on the carpet?"},"Form",{ html: { include: "recall.html" }},],	
